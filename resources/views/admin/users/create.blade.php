...
<p style="font-family:Yekan;padding-right:30px;padding-top:20px;padding-bottom:10px;">ثبت کاربر جدید</p>
	...
	<div class="form-input">
		{!! Form::label('password','گذرواژه',['style'=>'width:150px;']) !!}
		{!! Form::password('password',null,['class'=>'inputfiled','style'=>'width:300px;margin-top:20px;']) !!}
	</div>
